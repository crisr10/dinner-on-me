...
,
                ...
                .done(function(data, textStatus, jqXHR) {
                        ...
                        var phone = restaurant.businesses[0].phone;
                        var image = restaurant.businesses[0].image_url;
                        var name = restaurant.businesses[0].name;
                        var ratingImage =restaurant.businesses[0].rating_img_url;
                        var snippet =restaurant.businesses[0].snippet_text;
                        console.log(image); 
                        console.log(phone);
                        $('#buttonsView').append('<div class="snippet">Review highlight: ' +snippet+ '</div>')
                        $('#buttonsView').append('<img src="'+ratingImage+'"class="ratingimage">' )
                        $('#buttonsView').append('<img src="'+image+'" class="image"> ')
                        $('#buttonsView').append('<div class="name">Business name: ' +name+ '</div>')
